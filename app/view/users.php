                ...
                <?php foreach ($user->list_all() as $this_user) { ?>
                    ...
                    <div class="profile-card">
                        ...
                        <div class="card-picture">
                            ...
                            <div class="picture" style="background: url(<?php echo($this_user['user_avatar']); ?>)"></div>

                        </div>

                        <div class="card-profile">

                            <span class="card-name"><?php echo $this_user['firstname'] . ' ' . $this_user['lastname']; ?>
                                (<?php echo $this_user['age']; ?>)</span>
                            <br>
                            <span class="card-title"><?php echo $this_user['role']; ?></span>
