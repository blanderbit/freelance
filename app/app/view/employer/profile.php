    ...
    <div class="main-content">
        ...
        <div class="employer-profile">
            ...
            <div class="profile-left">
                ...
                <form id="employer-data" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post"
                      class="boxed-sections">
                        ...
                        <table class="no-padding">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input name="name" type="text" placeholder="Bedrijfsnaam"
                                           value="<?php echo $this_employer['name']; ?>">
                    ...
                    <div class="boxed-section">
                        ...
                        <table class="no-padding">
                            ...
                            <tr>
                                ...
                                <td>E-mailadres</td>
                                <td><input name="email" type="email" value="<?php echo $this_employer['email']; ?>">
                                </td>
                    ...
                    <div class="boxed-section">
                        ...
                        <input name="street" type="text" value="<?php echo $this_employer['street']; ?>"
                               placeholder="Straat" class="half">
                        <input name="street_number" type="number" value="<?php echo $this_employer['street_number']; ?>"
                               placeholder="Nummer" class="quarter">
                        <input name="street_extra" type="text" value="<?php echo $this_employer['street_extra']; ?>"
                               placeholder="Extra" class="quarter">

                        <br>

                        <input name="postal" type="text" value="<?php echo $this_employer['postal']; ?>"
                               placeholder="Postcode" class="half">
                        <input name="city" type="text" value="<?php echo $this_employer['city']; ?>"
                               placeholder="Plaats" class="half">

                        <br>

                        <input name="country" type="text" value="<?php echo $this_employer['country']; ?>"
                               placeholder="Land">
                    ...
                    <div class="boxed-section">
                        ...
                        <div class="section-header">
                            ...
                            <div class="header-right">
                                ...
                                <a href="/export?type=locations&employer=<?php echo $this_employer['id']; ?>"
                                   target="_blank" class="button button-left">Exporteren</a>
                                <span onClick="mondial.location.add(<?php echo $this_employer['id']; ?>);"
                                      class="button button-right">Nieuwe locatie</span>
                            ...
                            <?php foreach ($employer->locations($this_employer['id']) as $location) { ?>
                                ...
                                <tr data-location="<?php echo $location['id']; ?>">
                                    ...
                                    <td style="text-align:right;">
                                        <div class="icon-edit"
                                             onClick="mondial.location.edit('<?php echo $location['id']; ?>')"></div>
                                    </td>
                    ...
                    <div class="boxed-section">
                        ...
                        <div class="section-header">
                            ...
                            <div class="header-right">
                                ...
                                <a href="/export?type=employer-shifts&employer=<?php echo $this_employer['id']; ?>&period=upcoming"
                                   target="_blank" class="button button-left">Exporteren</a>
                                <span onClick="mondial.shift.add('today', <?php echo $this_employer['id']; ?>);"
                                      class="button button-right">Nieuwe dienst</span>
                        ...
                        <table class="list">
                            ...
                            <?php foreach ($employer->shifts($this_employer['id'], 'UPCOMING') as $shift) { ?>
                                ...
                                <tr data-shift="<?php echo $shift['uid']; ?>">
                                    ...
                                    <td>
                                        <a href="/users/<?php echo $shift['user_id']; ?>"><?php echo $shift['user_name']; ?></a>
                                    </td>
                    ...
                    <div class="boxed-section">
                        ...
                        <div class="section-header">
                            ...
                            <div class="header-right">
                                ...
                                <a href="/export?type=employer-shifts&employer=<?php echo $this_employer['id']; ?>&period=complete"
